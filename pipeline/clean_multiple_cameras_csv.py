...
CSV_PATH = "datasets/processed/pose/multiple_cameras_fall/hybrid_pose.csv"
OUT_PATH = "datasets/processed/pose/multiple_cameras_fall/hybrid_pose_clean.csv"


def clean_multiple_cameras_csv(csv_path, out_path):
    print(f"\nCleaning multiple_cameras_fall: {csv_path}")
...
if __name__ == "__main__":
    clean_multiple_cameras_csv(CSV_PATH, OUT_PATH)